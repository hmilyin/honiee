package com.ryan.doubletrack.utils;
...
//		String file = new Random().nextInt(99999999) + ".jpg";
	...
	public static void main(String[] args) throws Exception {
		String text = "http://www.honiee.com?channel=101&spreadId=100283";
		String fileName = "12312.jpg";
		QRCodeUtil.encode(text, "D:/qrcode/test/logo.jpg", "D:/zxing/test",fileName, false);
		String url = QRCodeUtil.decode("D:/zxing/test/"+fileName);
		System.out.println("url:"+url);
		System.out.println(new QRCodeUtil().getClass().getResource("/").getPath());
	}
}
