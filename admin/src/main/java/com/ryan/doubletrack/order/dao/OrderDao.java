package com.ryan.doubletrack.order.dao;
...
public interface OrderDao<M extends Model,PK extends Serializable> extends BaseHibernateDao<M,PK>{
	public List<M> findByModel(M model);
	public List<M> findByModel(Page page,M model);
	public void deleteByIds(String pks);
	public void cleanOrderHistory(M model);
}
