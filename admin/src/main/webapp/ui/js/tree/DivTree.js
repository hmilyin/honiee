...
xyTree.TreeConfig = {
   ...
   * 打开的文件夹，叶节点
   */
  rootIcon        : '../../themes/default/images/xyTree/foldericon.gif',
  openRootIcon    : '../../themes/default/images/xyTree/openfoldericon.gif',
  ...
  buzhongIcon     : '../../themes/default/images/xyTree/buzhong.gif',
  quanzhongIcon   : '../../themes/default/images/xyTree/quanzhong.gif',
  jubuzhongIcon   : '../../themes/default/images/xyTree/jubuzhong.gif',
  readonlyzhongIcon   : '../../themes/default/images/xyTree/readonlyzhong.gif',
...
/**
 * 得到被选中的第五层节点数组(用于YUM项目)
 * @return 得到被选中的第五层节点数组(用于YUM项目)
 * @type Array:xyTree.Node  
 */
xyTree.DivTree.prototype.getNodesMojiForYum = function() {
  function getNodesdiguiMoji(arr, node) {
    function getNodesdiguiMojiSelected(node2) { //闭包，arr相同
      if (node2.level == 4)
        arr.push(node2);
 ...
 * @param timenum 可选参数，颜色渐变的时间，越大颜色保留越长，默认300
 */
xyTree.DivTree.prototype.myCheckedNode = function(node) {
  //alert("myCheckedNode-------->"+node.id+","+node.name+","+node.checked);
  ...
  var fuxuan = node.getHtmlElementfuxuanimg();
  node.checked=checked;
  //alert("myCheckedNode befor enter onclickReadOnly-------->"+node.id+","+node.name+","+node.checked);
  fuxuan.onclickReadOnly(node);
}
